...
/*******************************************************************************
 * Function Name  : writeInputSourceRegister
 * Description    :
 * Input          : NONE
 * Return         :
 *******************************************************************************/

void PMIC::writeInputSourceRegister(byte value) {
	writeRegister(INPUT_SOURCE_REGISTER,value);
}
...
// bool PMIC::setChargeCurrent(void) {
// 	byte DATA = readRegister(CHARGE_CURRENT_CONTROL_REGISTER);
// 	writeRegister(CHARGE_CURRENT_CONTROL_REGISTER, 0b00000000;
// 	return 1;
// }
